...
<script>
// Funcția care reîncarcă pagina cu filtrul de timp
...
new Chart(ctx, {
  ...
  { 
    ...
    backgroundColor: '#3b82f6', // Un albastru vibrant (Indigo)
    borderColor: '#2563eb', 
    borderWidth: 1,
    borderRadius: 4 // Rotunjim puțin colțurile barelor pentru un look modern
  },
  { 
    label: 'Semestrul 2', 
    data: <?= json_encode(array_column($stats, 'Sem2')) ?>, 
    backgroundColor: '#10b981', // Un verde-teal vibrant
    borderColor: '#059669', 
    borderWidth: 1,
    borderRadius: 4
  }
