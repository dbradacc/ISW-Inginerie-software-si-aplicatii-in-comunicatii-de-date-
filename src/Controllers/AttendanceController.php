...

{
    ...
    {
        // 1. Preluăm filtrele pentru tabel
        ...
        // 2. Preluăm filtrul de timp pentru grafic (range)
        // Dacă nu e selectat nimic, punem 'all' ca default
        $range = $_GET['range'] ?? 'all';

        // 3. Trimitem range-ul către funcția de statistici
        // (Va trebui să modificăm și Modelul imediat)
        $stats = $this->model->stats($range);
